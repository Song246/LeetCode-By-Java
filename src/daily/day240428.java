...
/**
 * 1017、负二进制转换（十进制转-2进制，延申到任意进制转换）
 * @program: LeetCode
 * @description:
 * @author: lydms
 * @create: 2024-04-28 13:48
 **/
public class day240428 {
    public static void main(String[] args) {
        Solution solution = new Solution();
        String string = solution.baseNeg2(3);
    ...
    public String baseNeg2(int n) {
        ...
        while (n != 0) {
            ...
            if (n % -2 == 0) {
                ...
                // 难点：n-1这个操作 n=n-1;  将最低位的值抹去后，使得n变为偶数，在进行除负二操作时是整除
                n = n - 1;    // 将奇数变为偶数，实现最低位对-2的整除
                // n=n-r 转任意r进制
                sb.append("1"); // 最低位取1，，1*x^{0}=+1 ，一定是正数，说明从 n 里分了一个正 1 出去，所以应该对 n 做减法。
            }
            n /= -2;
        }
        sb.reverse();
